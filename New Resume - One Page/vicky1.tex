...
% Right frame
%%%%%%%%%%%%%%%%%%%%
\placetextbox{0.90}{0.995}{\color{Plum}\tiny{Last Updated: Jun 27, 2016}}%
...
{\footnotesize Developed customized APIs for Amazon's generic wish-list API (GLAPI) \\\color{Black}
	\emph{Technologies Used:} Java, Spring, Lombok, Amazon's Internal Frameworks}%Project-4 End
\SmallSep\\
%Project-new1 Start
...
{\footnotesize Developed a tool to execute SQL Test scripts on a database, capture the results, and publish them onto an Auditing and Testing platform.\\ \emph{Technologies Used:} Microsoft VBA, SQL} 
%Project-5 Start
